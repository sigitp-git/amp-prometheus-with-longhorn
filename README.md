...
```
Admin:~/environment/amp $ export AMP_QUERY_ENDPOINT=ADD
...
`kubectl apply -f https://raw.githubusercontent.com/sigitp-git/amp-prometheus-with-longhorn/refs/heads/main/cm-prometheus-for-amp-server-n-prometheus-with-sriov.yaml --force`
